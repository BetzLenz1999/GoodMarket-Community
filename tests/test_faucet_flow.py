...
class FaucetFlowTests(unittest.TestCase):
    ...
    @patch("routes._has_recent_refill")
    @patch("routes._get_gas_status")
    def test_force_onchain_bypasses_recent_refill(self, mock_get_gas, mock_recent, mock_onchain):
        self._auth_session()
        ...
        mock_onchain.return_value = {"success": True, "status": "onchain_sent", "tx_hash": "0xforced"}
